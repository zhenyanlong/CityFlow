...
- **绑定控件：** `Btn_TriggerLSystem`、`Btn_StartSimulation`、`Btn_RestartPlanning`、`Txt_Phase`、`Txt_Budget`、`Txt_Score`、`Txt_Countdown`（BindWidgetOptional）、`PopupLayer`（BindWidgetOptional `CanvasPanel`）
