...
- Updated TDD.md and TDD_Chinese.md with CanonicalMask mapping table and rotation/scale strategy
- Updated DailyProgress.md and DailyProgress_Chinese.md with today's progress
```
