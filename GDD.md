...
Building foundations use restrained rounded corners, while their sidewalk rings sit slightly inside the foundation silhouette and use small inner/outer bevels. This avoids thin overhanging slabs and harsh black contact seams while keeping the footprint and doorway-road relationship readable from the gameplay camera.
